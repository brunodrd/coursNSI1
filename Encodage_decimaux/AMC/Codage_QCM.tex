...
Quelle est la valeur de l'entier naturel codé par le motif binaire $0001 1010$ ?
  ...
  \begin{question}{entierrelatif-Q7} \bareme{b=2,m=-0.25,e=-0.25,v=0}
	La méthode du complément à deux permet:
     \begin{reponses}
      ...
      \mauvaise{d'ajouter $1$ à un nombre entier écrit en binaire}
...
\element{codagereels}{
  \begin{question}{codagereels-Q4} \bareme{b=2,m=-0.25,e=-0.25,v=0}
	La représentation en virgule flottante est une écriture de la forme {\emph{signe}~$\vert$~\emph{exposant}$~\vert$~\emph{mantisse}}. Que vaut le nombre $0\ 10000011\ 10010100000000000000000$ codé en simple précision (\emph{32 bits})?
     \begin{reponseshoriz}
      \mauvaise{$131,578125$}
      \bonne{$25,25$}
  ...
  \begin{question}{codagereels-Q7} \bareme{b=2,m=-0.25,e=-0.25,v=0}
	Cochez une propriété correcte des nombres flottants sur une machine numérique.
     \begin{reponses}
      ...
      \mauvaise{La représentation avec tous les bits à zéro est interdite}
...
\begin{center}
	\hrule\vspace{2mm}
	\bf\Large Codage d'entiers naturels
	\vspace{1mm}\hrule
\end{center}
\restituegroupe{codageentiernaturel}
%
\begin{center}
	\hrule\vspace{2mm}
	\bf\Large Codage d'entiers relatifs
	\vspace{1mm}\hrule
\end{center}
\restituegroupe{codageentierrelatif}
%
\begin{center}
	\hrule\vspace{2mm}
	\bf\Large Codage de nombres réels
	\vspace{1mm}\hrule
\end{center}
\restituegroupe{codagereels}
\AMCcleardoublepage
