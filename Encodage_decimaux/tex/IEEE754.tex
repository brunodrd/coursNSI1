...
\hypertarget{analogie-avec-la-notation-scientifique-en-base-10}{%
\subsubsection{Analogie avec la notation scientifique en base
10}\label{analogie-avec-la-notation-scientifique-en-base-10}}

\hypertarget{forme-normalisuxe9e---standard-ieee754}{%
\subsubsection{Forme normalisée - standard
IEEE754}\label{forme-normalisuxe9e---standard-ieee754}}

\hypertarget{exemple}{%
\subsubsection{Exemple}\label{exemple}}

\hypertarget{cas-particuliers}{%
\subsection{Cas particuliers}\label{cas-particuliers}}
...
* 1 bit de signe \(s\); * un exposant; pour éviter d'avoir que des
grandes valeur, on décale cet exposant d'une certaine valeur (biais);\\
...
définie dans la norme IEEE 754. Celle-ci prévoit une représentation
simple précision sur 32 bits ou double précision sur 64 bits.
